"""Unit tests for probation-q-a-agent agent tools."""

import pytest

from agents.probation_q_a_agent.tools.sample_tool import greet_user
...
class TestGreetUser:
    ...
    def test_contains_agent_identifier(self):
        """Should identify itself as Probation Q A Agent."""
        result = greet_user("Test")
        assert "Probation Q A Agent" in result
